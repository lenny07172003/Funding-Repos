...
const navItems = [
  ...
  { href: "/client/credit", label: "Credit Data", icon: "chart" },
  { href: "/client/documents", label: "Documents", icon: "folder" },
  { href: "/client/funded", label: "Funded", icon: "dollar" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2">
            {brand.brandLogo ? (
              <img src={brand.brandLogo} alt={brand.brandName} className="w-8 h-8 rounded-lg object-contain" />
            ) : (
          ...
          <button
              ...
              className="hidden md:flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:text-red-600 transition-colors"
            >
